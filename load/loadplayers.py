...
class LoadPlayers:
    ...
    def load(self):
        ...
        self.transactions.append({'recno':56,'name':'Jeffrey S.','year':2013})
        self.transactions.append({'recno':57,'name':'Brandon G.','year':2013})
        self.transactions.append({'recno':58,'name':'Alexander M.','year':2013})
        self.transactions.append({'recno':59,'name':'Amos C.','year':2013})
        self.transactions.append({'recno':60,'name':'Larry J.','year':2013})
        self.transactions.append({'recno':61,'name':'Thai N.','year':2013})
        self.transactions.append({'recno':62,'name':'Simon C.','year':2013})
        self.transactions.append({'recno':63,'name':'Van S.','year':2013})
        self.transactions.append({'recno':64,'name':'Nick E.','year':2013})
        self.transactions.append({'recno':65,'name':'Amber N.','year':2013})
        self.transactions.append({'recno':66,'name':'David S.','year':2013})
        self.transactions.append({'recno':67,'name':'Steve W.','year':2013})
        self.transactions.append({'recno':68,'name':'Chris F.','year':2013})
        self.transactions.append({'recno':69,'name':'Kevin M.','year':2013})
        self.transactions.append({'recno':70,'name':'David B.','year':2013})
        self.transactions.append({'recno':71,'name':'Daniel D.','year':2013})
        self.transactions.append({'recno':72,'name':'Scott Fe.','year':2013})
        self.transactions.append({'recno':73,'name':'Greg I.','year':2013})
        self.transactions.append({'recno':74,'name':'Byron R.','year':2013})
        self.transactions.append({'recno':75,'name':'Matt H.','year':2013})
        self.transactions.append({'recno':76,'name':'Brent H.','year':2013})
        self.transactions.append({'recno':77,'name':'Dave L.','year':2013})
        self.transactions.append({'recno':78,'name':'William M.','year':2013})
        self.transactions.append({'recno':79,'name':'Jarred W.','year':2013})
        self.transactions.append({'recno':80,'name':'Chip A.','year':2013})
        self.transactions.append({'recno':81,'name':'Christopher E.','year':2013})
        self.transactions.append({'recno':82,'name':'Kevin F.','year':2013})
        self.transactions.append({'recno':83,'name':'Michael N.','year':2013})
        self.transactions.append({'recno':84,'name':'Charles N.','year':2013})
        self.transactions.append({'recno':85,'name':'Kevin S.','year':2013})
        self.transactions.append({'recno':86,'name':'Steve M.','year':2013})
        self.transactions.append({'recno':87,'name':'Adam S.','year':2013})
        self.transactions.append({'recno':88,'name':'Leslie F.','year':2013})
        self.transactions.append({'recno':89,'name':'Jeremy H.','year':2013})
        self.transactions.append({'recno':90,'name':'Robert J.','year':2013})
        self.transactions.append({'recno':91,'name':'Douglas M.','year':2013})
        self.transactions.append({'recno':92,'name':'Aaron P.','year':2013})
        self.transactions.append({'recno':93,'name':'Dale R.','year':2013})
        self.transactions.append({'recno':94,'name':'Scott D.','year':2013})
        self.transactions.append({'recno':95,'name':'Adam G.','year':2013})
        self.transactions.append({'recno':96,'name':'Tim P.','year':2013})
        self.transactions.append({'recno':97,'name':'Chris R.','year':2013})
        self.transactions.append({'recno':98,'name':'Carl S.','year':2013})
        self.transactions.append({'recno':99,'name':'Kenneth Y.','year':2013})
        self.transactions.append({'recno':100,'name':'Martin B.','year':2013})
        self.transactions.append({'recno':101,'name':'Chris C.','year':2013})
        self.transactions.append({'recno':102,'name':'Landon A.','year':2013})
        self.transactions.append({'recno':103,'name':'Jerome B.','year':2013})
        self.transactions.append({'recno':104,'name':'William C.','year':2013})
        self.transactions.append({'recno':105,'name':'David R.','year':2013})
        self.transactions.append({'recno':106,'name':'Seth W.','year':2013})
        self.transactions.append({'recno':107,'name':'LaMar P.','year':2013})
        self.transactions.append({'recno':108,'name':'Scott Fr.','year':2013})
