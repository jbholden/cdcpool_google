...
class LoadWeeks:
    ...
    def load(self):
        ...
        self.transactions.append({'recno':14,'number':1,'year':2013,'winner':80,'games':[131, 132, 133, 134, 135, 136, 137, 138, 139, 140]})
        self.transactions.append({'recno':15,'number':2,'year':2013,'winner':60,'games':[141, 142, 143, 144, 145, 146, 147, 148, 149, 150]})
        self.transactions.append({'recno':16,'number':3,'year':2013,'winner':63,'games':[151, 152, 153, 154, 155, 156, 157, 158, 159, 160]})
        self.transactions.append({'recno':17,'number':4,'year':2013,'winner':71,'games':[161, 162, 163, 164, 165, 166, 167, 168, 169, 170]})
        self.transactions.append({'recno':18,'number':5,'year':2013,'winner':70,'games':[171, 172, 173, 174, 175, 176, 177, 178, 179, 180]})
        self.transactions.append({'recno':19,'number':6,'year':2013,'winner':70,'games':[181, 182, 183, 184, 185, 186, 187, 188, 189, 190]})
        self.transactions.append({'recno':20,'number':7,'year':2013,'winner':85,'games':[191, 192, 193, 194, 195, 196, 197, 198, 199, 200]})
        self.transactions.append({'recno':21,'number':8,'year':2013,'winner':60,'games':[201, 202, 203, 204, 205, 206, 207, 208, 209, 210]})
        self.transactions.append({'recno':22,'number':9,'year':2013,'winner':87,'games':[211, 212, 213, 214, 215, 216, 217, 218, 219, 220]})
        self.transactions.append({'recno':23,'number':10,'year':2013,'winner':58,'games':[221, 222, 223, 224, 225, 226, 227, 228, 229, 230]})
        self.transactions.append({'recno':24,'number':11,'year':2013,'winner':67,'games':[231, 232, 233, 234, 235, 236, 237, 238, 239, 240]})
        self.transactions.append({'recno':25,'number':12,'year':2013,'winner':68,'games':[241, 242, 243, 244, 245, 246, 247, 248, 249, 250]})
        self.transactions.append({'recno':26,'number':13,'year':2013,'winner':66,'games':[251, 252, 253, 254, 255, 256, 257, 258, 259, 260]})
