...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route(r'/api/<year:([0-9]+)>/week/<week_number:([0-9]+)>/game/id/<game_id:([0-9]+)>', GameAPIGetById),
    webapp2.Route(r'/api/<year:([0-9]+)>/week/<week_number:([0-9]+)>/game', GameAPICreate),
