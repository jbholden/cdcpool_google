...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route(r'/api/game', GameAPIEditDelete),
    ...
    webapp2.Route(r'/api/<year:([0-9]+)>/<week_number:([0-9]+)>/game/id/<game_id:([0-9]+)>', GameAPIGetById),
    webapp2.Route(r'/api/<year:([0-9]+)>/<week_number:([0-9]+)>/game', GameAPICreate),
    webapp2.Route(r'/api/<year:([0-9]+)>/<week_number:([0-9]+)>/games', GameAPIMultipleCreate),
    ...
    webapp2.Route(r'/api/<year:([0-9]+)>/<week_number:([0-9]+)>/week/id/<week_id:([0-9]+)>', WeekAPIGetById),
    ...
    webapp2.Route(r'/api/<year:([0-9]+)>/<week_number:([0-9]+)>/picks', PickAPIMultipleCreate),
    webapp2.Route(r'/api/<year:([0-9]+)>/<week_number:([0-9]+)>/pick/id/<pick_id:([0-9]+)>', PickAPIGetById),
