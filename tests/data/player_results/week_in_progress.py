...
class PlayerResultsWeekInProgress(PlayerResultTestData):
    ...
    def setup_database(self):
        ...
        self.__saved_games[3] = self.__final_game(3,'Arizona State','Texas A&M','team1',spread=0.5,team1_score=20,team2_score=15)
        self.__saved_games[4] = self.__final_game(4,'New Mexico','Ohio State','team2',spread=14.5,team1_score=12,team2_score=15)
        self.__saved_games[5] = self.__in_progress_game(5,'Alabama','UCF','team2',spread=22.5,team1_score=30,team2_score=10,quarter=None,time_left=None)
        self.__saved_games[6] = self.__in_progress_game(6,'San Diego State','South Carolina','team2',spread=4.5,team1_score=21,team2_score=18,quarter="Halftime",time_left=None)
        self.__saved_games[7] = self.__in_progress_game(7,'Temple','North Texas','team1',spread=20.5,team1_score=41,team2_score=7,quarter="4th",time_left="4:30") 
        self.__saved_games[8] = self.__in_progress_game(8,'Syracuse','Baylor','team2',spread=16.5,team1_score=15,team2_score=21,quarter=None,time_left="7:30") 
