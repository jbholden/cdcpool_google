...
class PlayerResultsWeekNotStarted(PlayerResultTestData):
    ...
    def setup_database(self):
        ...
        self.__saved_games[2] = self.__not_started_game(2,'Wisconsin','Hampton','team2',18.5,datetime.datetime(1998,7,3,9,36))
        self.__saved_games[3] = self.__not_started_game(3,'Arizona State','Alabama A&M','team1',0.5,datetime.datetime(1988,5,19,2,21))
        self.__saved_games[4] = self.__not_started_game(4,'New Mexico','Ohio State','team2',14.5,datetime.datetime(2001,12,10,0,6))
        self.__saved_games[5] = self.__not_started_game(5,'Alabama','Brown','team2',22.5,datetime.datetime(1978,11,13,19,19))
        self.__saved_games[6] = self.__not_started_game(6,'San Diego State','Houston Baptist','team2',4.5,datetime.datetime(2011,5,16,22,45))
        self.__saved_games[7] = self.__not_started_game(7,'Sam Houston State','North Texas','team2',20.5,datetime.datetime(1999,10,18,6,54))
        self.__saved_games[8] = self.__not_started_game(8,'San Diego','Baylor','team2',16.5,datetime.datetime(2012,7,24,15,24))
    ...
    def __setup_expected_result(self,game_number):
        ...
        self.add_result(player_name='Brent',player_pick=player_pick,result='',team1=team1_name,team2=team2_name,
                        team1_score=game.team1_score,team2_score=game.team2_score,game_state='not_started',
