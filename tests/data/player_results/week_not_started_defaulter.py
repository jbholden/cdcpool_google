...
class PlayerResultsWeekNotStartedDefaulter(PlayerResultTestData):
    ...
    def setup_database(self):
        ...
        self.__saved_games[3] = self.__not_started_game(3,'Arizona State','Alabama A&M','team1',0.5,None)
        self.__saved_games[4] = self.__not_started_game(4,'New Mexico','Ohio State','team2',14.5,None)
        self.__saved_games[5] = self.__not_started_game(5,'Alabama','Brown','team2',22.5,None)
        self.__saved_games[6] = self.__not_started_game(6,'San Diego State','Houston Baptist','team2',4.5,None)
        self.__saved_games[7] = self.__not_started_game(7,'Sam Houston State','North Texas','team2',20.5,None)
        self.__saved_games[8] = self.__not_started_game(8,'San Diego','Baylor','team2',16.5,None)
